      ...
      <Card className="w-full max-w-md p-8 backdrop-blur-sm bg-card/95">
        ...
        <div className="text-center mb-4">
          <p className="text-sm text-muted-foreground">
            Sign in with Base to access all features
          </p>
        </div>
        
        {/* Base Wallet Sign In - PRIMARY METHOD */}
        <div className="mb-6 space-y-3">
          <Button
            onClick={handleBaseWalletLogin}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 hover:from-blue-700 hover:via-blue-800 hover:to-blue-900 text-white font-semibold py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
          >
        ...
        <div className="mt-8 pt-6 border-t border-border/50">
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Create your Base account in seconds - no email required
            </p>
          </div>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:from-blue-600 hover:via-blue-700 hover:to-blue-800 text-white font-semibold py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] border-0 mb-4"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                <Wallet className="h-6 w-6" />
              </div>
              <span>Create BASE Account</span>
          ...
          <div className="text-center space-y-1">
            <p className="text-xs text-muted-foreground">
              ✨ Secure • Decentralized • Instant Access
            </p>
